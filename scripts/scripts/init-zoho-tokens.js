...
function initZohoTokens() {
    return __awaiter(this, void 0, void 0, function () {
        var db, existingTokens, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    db = (_a.sent()).db;
                    return [4 /*yield*/, db.collection('zoho_tokens').findOne({
                            _id: new mongodb_2.ObjectId('pleadex-admin')
                        })];
                case 2:
                    ...
                    return [4 /*yield*/, db.collection('zoho_tokens').insertOne({
                            _id: new mongodb_2.ObjectId('pleadex-admin'),
                ...
                case 4:
                    error_1 = _a.sent();
                    console.error('Error initializing Zoho tokens:', error_1);
                    process.exit(1);
                    return [3 /*break*/, 5];
